...
TAU_DARK_THEME = TuiTheme(
    name="tau-dark",
    screen_background="#0c0f14",
    screen_text="#e6edf3",
    chrome_background="#11161d",
    chrome_text="#f0f6fc",
    muted_text="#7d8590",
    sidebar_background="#10151c",
    border="#252b33",
    transcript_background="#0a0d12",
    prompt_background="#0f141b",
    prompt_text="#f0f6fc",
    prompt_border="#252b33",
    autocomplete_background="#11161d",
    completion_selected="bold white on #1f6feb",
    completion_selected_description="white on #1f6feb",
    completion_description="bright_black",
    syntax_theme="ansi_dark",
    role_styles={
        "user": TuiRoleStyle(border="#252b33", body="white on #101923"),
        "assistant": TuiRoleStyle(border="#252b33", body="white on #0f1a14"),
        "tool": TuiRoleStyle(border="#252b33", body="white on #19160d"),
        "error": TuiRoleStyle(border="#3a2527", body="white on #241315"),
        "status": TuiRoleStyle(border="#252b33", body="white on #11161d"),
    },
)
